                            ...
                            <div {{-- style="padding: 10px;" --}}>
                                ...
                                @auth
                                    <form action="{{ route('detail-add', $product->id) }}" method="POST"
                                        ...
                                        @csrf
                                        <button type="submit" class="btn btn-primary px-4 text-white mb-3" href="/cart">Add
                                            to Cart</button>
                                    </form>
                                @else
                                    ...
                                    <li class="media mb-3">
                                        @if ($review->user->img_profile)
                                            <img src="{{ asset('storage/' . $review->user->img_profile) }}"
                                                class="mr-3 rounded-circle" alt="" style="object-fit:cover;" />
                                        @else
                                            <img src="{{ asset('images/bgemptyprofile.png') }}" class="mr-3 rounded-circle"
                                                alt=""
                      ...
                      height: 45px;" />
                            ...
                            <div style="border-radius: 10px; background-color: rgba(0, 116, 240, 0.2);">
                                <div class="p-3">
                                    ...
                                    @else
                                        <a class="btn btn-secondary px-4 text-white" href="{{ route('login') }}">Sign in to
                                            Reviews</a>
                                    @endauth
                                </div>
                            </div>
