                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12" data-aos="fade-up">
                                    <a href="{{ route('categories') }}" class="text-dark text-decoration-none">
                                        <h5>Games</h5>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div data-aos="fade-left">
                                <ul class="list-group list-group-flush">
                                    ...
                                    @forelse ($categories as $category)
                                        <a href="{{-- {{ route('categories-detail', $category->slug) }} --}}/categories?category={{ $category->slug }}"
                                            class="mb-2 component-categories d-block text-dark border-primary-category shadow-sm"{{--  data-aos="fade-up"
              ...
              <a class="component-products d-block" href="/details/1">
                ...
                <div class="products-price">Rp. 9.900</div>
                    ...
                    ">
                                            ...
                                            <div style="font-size: 13px; color:rgb(163, 163, 163)">
                                                {{ $product->user->store_name }}</div>
                                            <div
                                                class="starrating-profile risingstar d-flex justify-content-start no-pointer">
                                                <label for="star1" title="1 star" class="starOnProfile d-inline"
                                                    style="display: flex;">
                                                    <h6 class="d-inline" style="font-size: 14px">
                                                        @php
                                                            if (
                                                                $product->review->pluck('rate')->isNotEmpty() &&
                                                                $product->review->pluck('rate')->sum() !== 0
                                                            ) {
                                                                $totalSumOfRates = $product->review
                                                                    ->pluck('rate')
                                                                    ->flatten()
                                                                    ->sum();
                                                                $countSumOfRates = $product->review
                                                                    ->pluck('rate')
                                                                    ->flatten()
                                                                    ->count();
