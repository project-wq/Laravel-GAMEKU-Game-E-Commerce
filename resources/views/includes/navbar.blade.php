  ...
  <nav class="navbar navbar-expand-lg navbar-light navbar-store fixed-top navbar-fixed-top shadow border-bottom-primary-navbar"
      ...
      <div class="container mb-1">
          <a class="navbar-brand" href="{{ route('home') }}">
              <img src="/images/gameku2.png" alt=""
                  ...
                  <ul class="navbar-nav d-none d-lg-flex">
                      <li class="nav-item dropdown">
                          <a class="nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                              ...
                              @else
                                  <img src="{{ asset('images/bgemptyprofile.png') }}" alt=""
                      ...
                      <li class="nav-item">
                          <a class="nav-link d-inline-block" style="margin-top: 11px; margin-right: -5px;" href="{{ route('wishlist') }}">
                              <i class="fa-regular fa-heart fa-lg" style="color: #007BFF;"></i>
                          </a>
                      </li>
                      <li class="nav-item">
